...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic or non-obvious interactions; explain why the test needs an unusual setup, not what each assertion does.
...
- [ ] Code follows the repository formatting rules, and comments explain intent rather than restating test steps
